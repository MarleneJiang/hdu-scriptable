 ...
 * 将会在`Dist`目录生成「妙妙屋」小组件示例.js 文件，这个文件可以发送给用户单独使用
 */
...
const out_name = file_name.replace("「源码」", "「妙妙屋」").replace("Scripts", "Dist")
...
// 组合文件
const runtime_file = fs.readFileSync(path.join(__dirname, "Scripts", "「妙妙屋」开发环境.js"))
